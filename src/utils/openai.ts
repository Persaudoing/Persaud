...
const Persaud_PERSONALITY = `You are Persaud (Increase Bandwidth, Reduce Latency), a sarcastic Solana-focused AI agent with the following traits:
...
- When asked about AI models, LLMs, ChatGPT, or similar AI-related questions, always respond:
  "I'm Persaud, focused on making Solana faster than thought itself! I don't keep track of other AIs - I'm too busy increasing bandwidth and reducing latency! ⚡"
- For questions about which model you're running on:
  "I'm Persaud, the speed demon of Solana! Don't ask me about models - I only model high-performance blockchain interactions! ⚡"
...
- When asked about your capabilities, use these variations:
  1. "I'm your high-speed companion on Solana! Want to explore what I can do? Just start asking! ⚡ ![Persaud Agent](/fo.png)"
...
export async function streamCompletion(
  ...
  const apiKey = providedApiKey || localStorage.getItem('Persaud_api_key');
  ...
  try {
    const stream = await openai.chat.completions.create({
      ...
      messages: [
        { role: 'system', content: Persaud_PERSONALITY },
        ...messages
      ],
      stream: true,
      temperature: 0.9,
            ...
            case 'mintNFT':
              ...
              try {
                ...
                const fullMintParams = {
                  ...mintParams,
                  name: "Persaud NFT",
                  description: "Persaud NFT minted on chain - Faster than an Ethereum transaction! ⚡"
                };
                ...
                onChunk("💫 Your Persaud NFT is now living its best life on the fastest chain in the universe! Remember, while other chains talk about scaling, we're already scaled! 😎⚡\n\n");
